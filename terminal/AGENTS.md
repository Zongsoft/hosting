...
这是一个基于 [Zongsoft](https://github.com/Zongsoft/framework) [插件框架](https://github.com/Zongsoft/framework/tree/main/Zongsoft.Plugins) 的插件式应用的终端程序的 .NET 宿主项目。

> 它主要是用来模拟后端服务程序，因为本终端程序支持命令行交互，因此相对 [daemon](../daemon/) 宿主程序而言对人机调试更加方便友好。
